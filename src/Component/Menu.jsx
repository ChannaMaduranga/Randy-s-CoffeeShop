    ...
    <div id='menu'>
        ...
        <h2 className='text-xl lg:text-4xl font-semibold text-center' data-aos="fade-up">VIEW OUR MENU</h2>
         ...
         <div className='grid  gap-8 lg:gap-4 md:grid-cols-3 md:mx-8 lg:w-[70%] lg:mx-auto'>
            <div className='p-8 mx-16 md:mx-0 hover:bg-[#fbead7] 'data-aos="fade-right" onClick={()=>navigate('/menu/breakfast')} >
            ...
            <div className='p-8 mx-16 md:mx-0 hover:bg-[#fbead7]' data-aos="fade-up" onClick={()=>navigate('/menu/beverages')}>
