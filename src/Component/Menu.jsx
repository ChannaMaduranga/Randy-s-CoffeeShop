    ...
    <div id='menu'>
        ...
        <h2 className='text-2xl lg:text-4xl font-semibold text-center'>VIEW OUR MENU</h2>
         ...
         <div className='grid  gap-8 lg:gap-4 md:grid-cols-3 md:mx-8 lg:w-[70%] lg:mx-auto'>
            <div className='p-8 mx-16 md:mx-0 hover:bg-[#fbead7] ' onClick={()=>navigate('/menu/breakfast')} >
            ...
            <div className='p-8 mx-16 md:mx-0 hover:bg-[#fbead7]' onClick={()=>navigate('/menu/beverages')}>
            ...
            <div className='p-8 mx-16 md:mx-0 hover:bg-[#fbead7]' onClick={()=>navigate('/menu/dessert')}>
