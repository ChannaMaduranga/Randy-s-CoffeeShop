  ...
  return (
    <div className='lg:my-16' id='contact'>
      <div className='my-12 lg:my-16 '>
        ...
        <h2 className='text-2xl lg:text-4xl text-[#3e3e3e] font-semibold text-center' data-aos="fade-up">Get In Touch</h2>
        ...
        <div className='flex justify-center items-center gap-4 my-4' data-aos="fade-up">
      ...
      <div className='lg:w-[80%] lg:flex justify-center mx-auto'>
        <div className='lg:w-1/2 p-8' data-aos="fade-right">
          <iframe
            title="Google Map"
        ...
        <div className='lg:ml-8 w-1/2 h-full my-auto ' data-aos="fade-left">
